  ...
  useEffect(() => {
    const fetchSettings = async () => {
      ...
      const profilePromise = supabase
        .from("profiles")
        .select("full_name, business_name, business_whatsapp_number, notifications_enabled, timezone, theme, telegram_bot_token, telegram_chat_id, telegram_notifications_enabled, telegram_bot_username")
        .eq("id", user.id)
        .single();
